...
def premium(option_name, option_val, stock_data, r, T):
    stock_price = option_val["S"]
    strike_price = option_val["K"]
    regex = re.findall("[a-zA-Z]+", option_name)
    stock_name = regex[0]
    annualized_vol = stock_data[stock_name]
    option_type = regex[1]
    if option_type == "C":
